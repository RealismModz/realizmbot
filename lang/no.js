...
module.exports = {
announce: {
  err: "Ingen melding var gitt",
  suggest: "Du kan også bytte farge ved å skrive .embed <farge> som RED"
},
ban: {
perms: "Jeg har ikke tilgang",
user: "Du ga meg ikke et medlem å suspandere",
reason: "Ingen grunn gitt",
msg: "Suspanderte brukeren"
},
embed: {
  lmao: "Ingen farge gitt",
  msg: "Ok done now changed color embed of"
},
    start: {
      perms: ":warning: Du har ikke `manage messages` tilatelse til å bruke denne kommandoen eller :",
      channel: ":warning: Du må skrive en tekst kanal.",
